...
function PurchaseMovieDetails() {
    ...
    if (isLoadingGetMovie || isLoadingGetEpisodes || isLoadingRelatedMovies || isLoadingGetReviews || isLoadingCheckMovieInFavorite || isLoadingCheckPurchasedMovie) {
        return <Loading />
    }

    if (isErrorGetMovie || isErrorGetEpisodes || isErrorRelatedMovies || isErrorGetReviews || isErrorCheckMovieInFavorite || isErrorCheckPurchasedMovie) {
        return <ErrorPage />
    }
                        ...
                        <div className="col-9">
                            <div className="movie-info text-white">
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    {isAuthenticated && isPurchased && episodes?.length > 0 && (
                                        <Link
                                    ...
                                    <div className="d-flex flex-nowrap overflow-auto pb-3">
                                        ...
                                        {movie?.actors.map((actor) => (
                                            <div key={actor.id} className="text-center" style={{ flex: "0 0 13%" }}>
                                                ...
                                                <p className="mb-0 text-small text-gray-500">Diễn viên</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
...
export default PurchaseMovieDetails