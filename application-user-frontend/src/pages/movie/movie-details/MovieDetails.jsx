...
function MovieDetails() {
  ...
  if (isLoadingGetMovie || isLoadingGetEpisodes || isLoadingRelatedMovies || isLoadingGetReviews || isLoadingCheckMovieInFavorite) {
    return <Loading />
  }

  if (isErrorGetMovie || isErrorGetEpisodes || isErrorRelatedMovies || isErrorGetReviews || isErrorCheckMovieInFavorite) {
    return <ErrorPage />
  }
